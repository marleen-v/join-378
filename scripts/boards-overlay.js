    ...
    return /*html*/`
        <section class="detailed-card">
            ...
            <div class="add-task-card-bottom flex justify-content-flex-end align-items-center">
                <div class="add-task-delete mg-right-left-8px">${trashSVG()}</div><span class="mg-right-8px">Delete</span>
                <div class="add-task-edit mg-right-left-8px">${editSVG()}</div><span>Edit</span>
            </div>
        </section>  
    `;
}
